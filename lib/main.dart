...
import 'package:wedding_planner/gradient_background.dart';
import 'package:wedding_planner/model/categori_model.dart';
import 'package:wedding_planner/model/hero_id_model.dart';
import 'package:wedding_planner/model/task_model.dart';
import 'package:wedding_planner/model/todo_list_model.dart';
import 'package:wedding_planner/page/add_card_screen.dart';
import 'package:wedding_planner/page/budget_screen.dart';
import 'package:wedding_planner/page/detail_screen.dart';
import 'package:wedding_planner/task_progress_indicator.dart';
import 'package:wedding_planner/utils/color_utils.dart';
import 'package:wedding_planner/utils/datetime_utils.dart';

import 'page/checlist_screen.dart';
...
class _MyHomePageState extends State<MyHomePage>
  ...
  Widget build(BuildContext context) {
    return ScopedModelDescendant<TodoListModel>(
      ...
      var _categoris = model.categoris;
      var _checks = model.checks;
                ...
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => MyHomePage(title: '')));              
                      },
                  ),
                  ListTile(
                    ...
                    // onTap: (){
                    //    Navigator.of(context).pop();
                    //   Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => CheckPage(title: '')));              
                   ...
                   ListTile(
                    ...
                    onTap: (){
                      Navigator.of(context).pop();
                      Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => Budget()));
